 ...
 *
 * IMPORTANT (performance): this module must NOT import `@/lib/site`. That module
 * eagerly loads the 14 MB `site-seed.json`, which used to be inlined into every
 * admin route bundle (~15.7 MB server chunks) and made each admin request slow.
 * The lightweight id/name/count projection lives in
 * `src/data/admin-columns-meta.json` (generated by scripts/build-runtime-data.mjs).
 */
...
const adminCategories = meta.categories ?? [];
const contentCounts = meta.contentCounts ?? {};
...
function staticItemCount(sourceId: number): number {
  return contentCounts[String(sourceId)] ?? 0;
}

export function getAdminSections(): AdminSection[] {
  const count = (sourceId: number) => staticItemCount(sourceId);
  ...
  const sections: AdminSection[] = [
    {
      ...
      nameEn: "About Us",
      columns: [
        { sourceId: 13, name: "About Us", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(13) },
        { sourceId: 55, name: "Main Products", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(55) },
        { sourceId: 16, name: "Honor", displayType: "image-list", dataSource: "static", parentId: 1, itemCount: count(16) },
        { sourceId: 56, name: "Culture", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(56) },
        { sourceId: 169, name: "Branch Companies", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(169) },
        { sourceId: 171, name: "Factory & Warehouse", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(171) },
        { sourceId: 172, name: "Course", displayType: "single", dataSource: "static", parentId: 1, itemCount: count(172) },
      ],
    },
    {
      pid: 2,
    ...
    },
    {
      ...
      name: "产品展示",
      nameEn: "Products",
      columns: adminCategories.map((cat) => ({
    ...
    },
    {
      ...
      columns: [
        { sourceId: 45, name: "Packing Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(45) },
        { sourceId: 142, name: "BOPP Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(142) },
        { sourceId: 143, name: "BOPET Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(143) },
        { sourceId: 144, name: "Tape Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(144) },
        { sourceId: 149, name: "Thermal Lamination Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(149) },
        { sourceId: 164, name: "Bruckner Production Lines (Germany)", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(164) },
        { sourceId: 165, name: "Mitsubishi Production Lines (Japan)", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(165) },
        { sourceId: 167, name: "Copy Paper Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(167) },
        { sourceId: 173, name: "Silver Metallized Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(173) },
        { sourceId: 174, name: "POF Film Production Lines", displayType: "image-list", dataSource: "static", parentId: 44, itemCount: count(174) },
      ],
    },
    {
      pid: 53,
